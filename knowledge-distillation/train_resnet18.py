"""
@file: train_resnet18.py
@description: Training and evaluation of a custom ResNet18 model on CIFAR-10
study of transfer learning and knowledge distillation.
...
def train_and_save_best_model(model, train_loader, test_loader, epochs, device):
    ...
    if best_model_state_dict is not None:
        model_save_path = "knowledge-distillation/saved_models/resnet18_64_adam.pth"
        ...
        save_path = f"knowledge-distillation/results/resnet18_64_adam.png"
...
if __name__ == "__main__":
    ...
    train_and_save_best_model(teacher_model, train_loader, test_loader, epochs=epochs, device=device)
